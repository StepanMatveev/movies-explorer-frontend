  ...
  return (
    <section className='project' id='project'>
      ...
      <div className='project__list'>
        <div className='project__list-block'>
          <h3 className='project__list-title'>Дипломный проект включал 5 этапов</h3>
        ...
        <div className='project__list-block'>
          <h3 className='project__list-title'>На выполнение диплома ушло 5 недель</h3>
